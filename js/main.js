...
(function($) {
    ...
    // Define the filtering functions globally
    ...
    window.addClass = function(element, name) {
        var i, arr1, arr2;
    ...
    window.removeClass = function(element, name) {
        var i, arr1, arr2;
        arr1 = element.className.split(" ");
        arr2 = name.split(" ");
        for (i = 0; i < arr2.length; i++) {
    ...
    // Invoke the initial filtering function after the document is ready
    $(function() {
        filterSelection("all");
    });
